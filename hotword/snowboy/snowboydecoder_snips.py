...
class HotwordDetector(object):
    ...
    def enableDetection(self):
        logger.info("Enabling detection")
        self._detectionEnabled = True
    
    def disableDetection(self):
        logger.info("Disabling detection")
        self._detectionEnabled = False
    
    def addHotwordDetectedListener(self, listener):
        self._listeners.append(listener)
    
    def onNewFrames(self, channels, framerate, samplewidth, numframes, frames):
        self.ring_buffer.extend(frames)
    ...
    def start(self, detected_callback=play_audio_file,
        ...
        while True:
            if interrupt_check():
                logger.debug("Ending voice detection requested")
                break
            ...
            if ans == -1:
                ...
                if self._detectionEnabled:
                    ...
                    logger.info("Hotword detected but currently disbaled, ignoring...")
